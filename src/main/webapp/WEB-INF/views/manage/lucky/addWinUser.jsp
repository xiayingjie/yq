...
<body>
<form class="form-horizontal" id="addform" method="post" action="${ctx}/admin/winUser/add">
    <fieldset>
        <div id="legend" class="">
            <legend class="">增加中奖人信息</legend>
        </div>
       ...
       <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" placeholder="" name="product" id="product"
                       class="validate[required]">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" placeholder="" name="date" id="date"
                       class="validate[required]">
