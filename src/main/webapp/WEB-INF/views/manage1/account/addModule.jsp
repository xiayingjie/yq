...
<body>
<form class="form-horizontal" id="addform" method="post" action="${ctx}/admin/module/add">
    <fieldset>
        <div id="legend" class="">
            <legend class="">增加模块</legend>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" placeholder="" name="moduleName" id="moduleName"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <input type="text" placeholder="" id="moduleInfo" name="moduleInfo"
